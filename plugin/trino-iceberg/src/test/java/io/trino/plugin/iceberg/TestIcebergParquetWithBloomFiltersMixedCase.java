        ...
        extends BaseTestParquetWithBloomFilters
{
    ...
    protected CatalogSchemaTableName createParquetTableWithBloomFilter(String columnName, List<Integer> testValues)
    {
        ...
        minio.processAndCopyResources("iceberg/mixed_case_bloom_filter", rewriteManifests(s3Location), BUCKET_NAME, tableLocation);
    ...
    public Minio.ResourcePreProcessor rewriteManifests(String newLocation)
    {
